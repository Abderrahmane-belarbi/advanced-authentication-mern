export function GitHubIcon({ w = 18, h = 18 }) {
  return (
...
export function FacebookIcon({ w = 18, h = 18 }) {
  return (
    <svg width={w} height={h} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="#1877F2"
        d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.414c0-3.028 1.792-4.704 4.533-4.704 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.49 0-1.953.93-1.953 1.887v2.27h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"
      />
    </svg>
  );
}

export function GoogleIcon({ w = 18, h = 18 }) {
  return (
    <svg width={w} height={h} viewBox="0 0 48 48" aria-hidden="true">
      <path
        fill="#FFC107"
